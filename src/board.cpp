...
{
    bitboards[PAWN][WHITE]  = 0x0000000000083200;  // Pawns on d2, f3, g3, e5
    bitboards[PAWN][BLACK]  = 0x0000200000008800;  // Pawns on e6, d7, h7

    bitboards[ROOK][WHITE]  = 0x0000000000000080;  // Rook on h1
    bitboards[ROOK][BLACK]  = 0x0000000000000000;  // No black rooks

    bitboards[KNIGHT][WHITE] = 0x0000000000000004; // Knight on c1
    bitboards[KNIGHT][BLACK] = 0x0000000000000000; // No black knights

    bitboards[BISHOP][WHITE] = 0x0000000000000400; // Bishop on e3
    bitboards[BISHOP][BLACK] = 0x0000000000002000; // Bishop on g6

    bitboards[QUEEN][WHITE]  = 0x0000000000000008; // Queen on d1
    bitboards[QUEEN][BLACK]  = 0x0000000800000000; // Queen on d6

    bitboards[KING][WHITE]   = 0x0000000000000010; // King on e1
    bitboards[KING][BLACK]   = 0x1000000000000000; // King on e8
